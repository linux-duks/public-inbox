...
The sort order is recorded in the extindex C<misc> index; run
L<public-inbox-extindex(1)> with C<--reindex> (or C<--all>) after
adding or changing this value for an inbox before it is reflected
on the C<all> listing page.
